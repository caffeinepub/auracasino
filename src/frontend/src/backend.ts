...
export class Backend implements backendInterface {
    ...
    async adminTopUpUser(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminTopUpUser(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async drawCard(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.drawCard();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async playHiLo(arg0: bigint, arg1: string, arg2: bigint): Promise<HiLoResult> {
        if (this.processError) {
            try {
                const result = await this.actor.playHiLo(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async playRoulette(arg0: bigint, arg1: string, arg2: bigint): Promise<PlayResult> {
        if (this.processError) {
            try {
    ...
    async playSlots(arg0: bigint): Promise<SlotsResult> {
        if (this.processError) {
            try {
                const result = await this.actor.playSlots(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
