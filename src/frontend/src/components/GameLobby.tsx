      ...
      >
        ...
        <div className="flex flex-col gap-4 mt-2">
          ...
          <a
            ...
            className="w-full h-11 text-sm font-semibold tracking-wider rounded-lg flex items-center justify-center gap-2 transition-all duration-200 hover:opacity-90"
...
export default function GameLobby() {
  ...
  const [loginGameName, setLoginGameName] = useState("");
  ...
  function handleRequireLogin(gameName: string) {
    setLoginGameName(gameName);
        ...
        {selectedGame === null ? (
          ...
          >
            ...
            {selectedGame === "roulette" && (
              <RouletteGame
                onRequireLogin={() => handleRequireLogin("ROULETTE")}
              />
            )}
            {selectedGame === "aviator" && (
              <AviatorGame
                onRequireLogin={() => handleRequireLogin("AVIATOR")}
              />
            )}
            {selectedGame === "teenPatti" && (
              <TeenPattiGame
                onRequireLogin={() => handleRequireLogin("TEEN PATTI")}
              />
            )}
          </motion.div>
        )}
